...
<body>
    ...
    <section class="product-shop spad">
		...
		<c:if test="${startPage>1 }">
		  <a href="../youtube/you_tuber.do?page=${startPage-1}"><li class="page">&lt;</li></a>
		 </c:if>
		<c:forEach var="i" step="1" begin="${startPage }" end="${endPage }">
			<a href="../youtube/you_tuber.do?page=${i}">
			<c:if test="${curpage==i}">
		...
		<c:if test="${endPage<allPage }">
		  <a href="../youtube/you_tuber.do?page=${endPage+1}"><li class="page">&gt;</li></a>
		 </c:if>
		</ul>
