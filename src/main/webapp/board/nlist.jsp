 ...
 <div class="container">
  ...
  <tr>
   ...
   <table class="table">
    <tr>
     <td class="text-left">
     <form method=post action="../board/nfind.do">
      Search:<select name="fs" class="input-sm">
       <option value="N">작성자</option>
       <option value="S">제목</option>
       <option value="C">내용</option>
       <option value="NS">작성자+제목</option>
       <option value="NC">작성자+내용</option>
       <option value="SC">제목+내용</option>
       <option value="NSC">작성자+제목+내용</option>
      </select>
       ...
       <td class="text-center">
         <ul class="pagination">
	         ...
	         <c:forEach var="i" begin="${startPage }" end="${endPage }">
	           <li><a href="../board/nlist.do?page=${i }">${i }</a></li>
	         </c:forEach>
	         <li><a href="#">&gt;</a></li>
	     </ul>
       </td>
